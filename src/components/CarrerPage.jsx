  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-100 flex justify-center items-center px-4 sm:px-6 lg:px-12 2xl:px-16 py-12 sm:py-16 lg:py-20 2xl:py-24">
      <div className="flex flex-col items-center justify-center w-full max-w-6xl 2xl:max-w-[1920px]">
        <div className="w-full sm:w-3/4 md:w-1/2 lg:w-1/2 2xl:w-2/5 text-center md:text-left mt-8 md:mt-0 animate-fadeIn">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl 2xl:text-6xl font-extrabold text-gray-900 mb-4 2xl:mb-6 tracking-tight">
          ...
          <div className="flex justify-center">
            <a
              ...
              className="inline-block bg-gradient-to-br from-[#0078B4] to-[#00B4D9] text-white font-semibold px-6 sm:px-8 lg:px-8 2xl:px-10 py-2 sm:py-3 lg:py-3 2xl:py-4 rounded-lg hover:from-blue-700 hover:to-indigo-700 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-300 text-sm sm:text-base lg:text-base 2xl:text-lg"
